  ...
  useEffect(() => {
    ...
    if (video) {
      const handleLoadedData = () => {
        video.playbackRate = 0.25; // 4x slower
        video.currentTime = 20; // Start at 20 seconds
      };
      ...
      <div className="hero-wrapper">
        ...
        <section className="hero-modern">
          ...
          <div className="hero-modern-content">
            <h1>
              <span className="title-line-1">Device-agnostic RPM</span>
          ...
          <div className="hero-stats">
            ...
            <div className="hero-stat">
              ...
              <div className="stat-label">Metrics captured</div>
            </div>
            <div className="hero-stat">
